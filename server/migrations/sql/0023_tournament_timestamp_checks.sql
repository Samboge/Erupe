...
ALTER TABLE tournaments
    ADD CONSTRAINT tournaments_start_time_positive  CHECK (start_time  > 0),
    ADD CONSTRAINT tournaments_entry_end_positive   CHECK (entry_end   > 0),
    ADD CONSTRAINT tournaments_ranking_end_positive CHECK (ranking_end > 0),
    ADD CONSTRAINT tournaments_reward_end_positive  CHECK (reward_end  > 0);
